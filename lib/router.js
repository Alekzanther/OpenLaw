...
FlowRouter.route('/login/', {
    ...
    action: function(params, queryParams) {
        FlowLayout.render('layout', {main: "login" , header: "header"});
    }
});
...
FlowRouter.route('/article/:id', {
    ...
    // onwards to the article page
    action: function(params, queryParams) {
        FlowLayout.render('layout', {main: "article_page" , header: "header"});
    }
});
...
FlowRouter.route('/', {
    ...
    action: function(params, queryParams) {
        FlowLayout.render('layout', {main: "home", header: "header"});
    }
});
